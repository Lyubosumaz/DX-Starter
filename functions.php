...
function dxstarter_scripts() {
	wp_enqueue_style( 'dxstarter-style', get_stylesheet_uri() );

	wp_enqueue_script( 'dxstarter-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
